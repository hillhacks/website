...
Gaggal, about 30-45 minutes south of Dharamshala.(Beware: due to weather and
other issues, flights to or from Dharamshala can be cancelled at the last minute,
so it's wise to schedule in some breathing room, and maybe a Plan B).
If your flight does manage to reach Dharamshala airport, you can make the onward
journey from there to Bir by bus or taxi (see the relevant sections below for details).

[1]: https://en.wikipedia.org/wiki/Dharamsala_airport

The other airports which are a bit far but have more reliable connectivity
and more scheduled flights are Chandigarh and Delhi. For most people, coming to Delhi
on a flight and then taking a direct bus to Bir is the most reliable way to reach here.
...
Note that none of the regular buses go to the Chowgan Chowk,if your bus drops you
at Bir road bus stop, you can either take a bus to Upper Bir and ask the driver
or conductor to drop you off at Chowgan Chowk (the intersection where Bir Road meets Chowgan Road).
The other option from Bir road bus stop is to take a direct taxi to the venue. Ask the 
taxi driver to drop you at "Bagicha" or show them the address.
